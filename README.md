...
- ### 游戏引擎结构
  ...
  - gameManager “法人”的方法和它的重要“非人”
    ...
    > playerMove.nowFn &&= playerMove.nowFn?.() || temp.defaultFn?.() // playerMove 尝试使用现在的 nowFn 方法来决定下一次的 nowFn 方法，如果现在的或下一次的 nowFn 方法可以转变为 false，那么 playerMove 将有空使用 defaultFn 方法
    > ```
